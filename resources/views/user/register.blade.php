...
<header class="max-w-lg mx-auto">
    <a href="#">
        <h1 class="text-4xl font-bold text-Black text-center mt-3">Student Register</h1>
    </a>
...
<main class="bg-white max-w-lg mx-auto p-8 my-10 rounded-lg shadow-2xl">
    ...
    <section class="mt-10">
        <form action="/store" method="POST" class="flex flex-col">
            ...
            hover:shadow-xl transition duration-200" type="submit">Sign up</button>
            <p class="text-gray-600 pt-2 text-center"> Sign in to your account <a href="login" class="text-purple-500 font-bold">here</a></p>
        </form>
    </section>
</main>
